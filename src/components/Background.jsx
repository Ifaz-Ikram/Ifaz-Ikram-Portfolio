		...
		<div className="fixed inset-0 hidden dark:block pointer-events-none">
			<div className="absolute inset-0">
				...
				<div
					...
					className="absolute top-0 -right-4 w-96 h-96 bg-cyan-500 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[128px] opacity-40 dark:opacity-20 hidden sm:block"></div>
				<div
